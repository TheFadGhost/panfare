 ...
 */
// urlsafe is applied at the final mapping step (source.url) and anywhere
// a stored URL becomes a link again.
import { safeUrl } from "./urlsafe.mjs";
...
// IDs are generated by core/id.mjs (makeId); recipes use prefix "r".
